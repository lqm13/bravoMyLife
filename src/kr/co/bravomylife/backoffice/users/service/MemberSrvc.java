 ...
 *				: [20241023102716][alstjsrla28#gmail.com][CREATE: Initial Release]
 */
...
import kr.co.bravomylife.backoffice.users.dao.MemberDao;
 ...
 * <p>IMPORTANT:</p>
 */
@Service("kr.co.bravomylife.backoffice.users.service.MemberSrvc")
public class MemberSrvc {
	...
	public boolean updateLast(MemberDto memberDto) {
		...
		int result = memberDao.updateLast(memberDto);
